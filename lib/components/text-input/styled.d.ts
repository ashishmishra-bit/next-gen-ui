...
export declare const StyledCross: import("styled-components").StyledComponent<(props: import("react").SVGProps<SVGSVGElement>) => JSX.Element, any, StyledCrossProps, never>;
export {};
